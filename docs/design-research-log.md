...
- VERIFIED external guidance: MDN logical properties and text wrapping, W3C WCAG 2.2 target sizing, and Apple HIG layout/safe-area principles were reviewed for directional implementation guidance. https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Logical_properties_and_values ; https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/text-wrap ; https://www.w3.org/WAI/WCAG22/Understanding/target-size-minimum
