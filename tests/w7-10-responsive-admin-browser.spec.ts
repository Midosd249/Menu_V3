...
test("W7.10 Platform Admin responsive route matrix", async ({ page }) => {
...
test("W7.10 Platform Admin narrow navigation remains keyboard reachable", async ({ page }) => {
...
test("W7.10 Platform Admin legacy query remains safe at narrow width", async ({ page }) => {
