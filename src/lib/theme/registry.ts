...
const definitions: readonly ThemeDefinition[] = [
  {
    key: "editorial", name: { ar: "تحريري", en: "Editorial" },
  ...
  {
    key: "dark-dining", name: { ar: "عشاء داكن", en: "Dark Dining" },
  ...
  {
    key: "coffee", name: { ar: "قهوة مختصة", en: "Specialty Coffee" },
  ...
  {
    key: "heritage", name: { ar: "تراث سعودي", en: "Saudi Heritage" },
  ...
  {
    key: "fast-casual", name: { ar: "سريع وعصري", en: "Fast Casual" },
  ...
  {
    key: "gallery", name: { ar: "معرض", en: "Gallery" },
  ...
  {
    key: "immersive", name: { ar: "غامر", en: "Immersive" },
  ...
  {
    key: "minimal", name: { ar: "مينيمال", en: "Minimal" },
