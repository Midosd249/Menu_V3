...
const definitions: readonly ThemeDefinition[] = [
  {
    ...
    capabilities: { dark: false, imageFirst: false, compact: false, immersive: false, featuredComposition: false, decorativeSurfaces: false, motion: false }, motion: "quiet", preview: { className: "preview-essential" },
  },
  {
    ...
    layout: { header: "hero", productGrid: "list", productCard: "editorial", categoryNav: "sticky", imageRatio: "portrait" }, capabilities: { dark: false, imageFirst: true, compact: false, immersive: false, featuredComposition: true, decorativeSurfaces: true, motion: true }, motion: "editorial", preview: { className: "preview-editorial" },
  },
  {
