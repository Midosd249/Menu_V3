import type { TemplateFamily, ThemeDefinition, ThemeKey } from "./types.ts";
...
const definitions: readonly ThemeDefinition[] = [
  {
    key: "essential", family: "small-menu", tier: "free", name: { ar: "أساسي", en: "Essential" },
    ...
    tags: [{ ar: "مجاني", en: "Free" }, { ar: "واضح", en: "Clear" }, { ar: "سريع", en: "Fast" }], tokens: baseTokens,
  ...
  {
    key: "editorial", family: "contemporary-restaurant", tier: "free", name: { ar: "Signal Table", en: "Signal Table" },
    description: { ar: "واجهة ضيافة رقمية عربية أولاً، واضحة، هادئة، ومصممة حول الطعام والطلب.", en: "An Arabic-first hospitality interface designed around food discovery and confident ordering." },
    promise: { ar: "هوية المطعم → الاختيار المميز → الفئات → تدفق الأصناف → التفاصيل → الطلب.", en: "Identity → signature selection → cuisine rail → menu stream → detail → order." },
    tags: [{ ar: "مجاني", en: "Free" }, { ar: "عربي أولاً", en: "Arabic-first" }, { ar: "بريميوم", en: "Premium" }],
    tokens: { ...baseTokens, colors: { ...baseTokens.colors, background: "#f7f5f0", surface: "#ffffff", surfaceMuted: "#f0f1f3", border: "#e5e7ea", primary: "#101827", accent: "#315bff", muted: "#667085" }, typography: { ...baseTokens.typography, headingWeight: 700, lineHeight: "1.7", letterSpacing: "0" }, shape: { ...baseTokens.shape, radiusLg: "1rem", radiusXl: "1.4rem" }, spacing: { page: "1rem", section: "3rem", card: "1rem", gap: "1rem" }, effects: { shadow: "0 8px 28px rgb(16 24 39 / .08)", shadowHover: "0 18px 42px rgb(16 24 39 / .14)", overlay: "rgb(16 24 39 / .46)" } },
    layout: { header: "hero", productGrid: "list", productCard: "editorial", categoryNav: "sticky", imageRatio: "landscape" },
    capabilities: { dark: false, imageFirst: true, compact: false, immersive: false, featuredComposition: true, decorativeSurfaces: false, motion: true }, motion: "quiet", preview: { className: "preview-signal-table", image: "https://images.unsplash.com/photo-1515003197210-e0cd71810b5f?auto=format&fit=crop&w=1400&q=88" },
  },
  {
    ...
    tokens: { ...baseTokens, colors: { background: "#0d0b0a", foreground: "#f6efe6", surface: "#171311", surfaceMuted: "#211a16", border: "#3a2e27", primary: "#f6efe6", primaryForeground: "#0d0b0a", accent: "#d29a5f", accentForeground: "#17110d", muted: "#aa9b90", mutedForeground: "#aa9b90" }, typography: { ...baseTokens.typography, headingWeight: 600, lineHeight: "1.58", letterSpacing: "-0.008em" }, shape: { radiusSm: "0.25rem", radiusMd: "0.5rem", radiusLg: "0.75rem", radiusXl: "1rem" }, spacing: { page: "1rem", section: "3.25rem", card: "1rem", gap: "1rem" }, effects: { shadow: "0 12px 36px rgb(0 0 0 / .28)", shadowHover: "0 28px 70px rgb(0 0 0 / .42)", overlay: "rgb(0 0 0 / .62)" } },
    layout: { header: "immersive", productGrid: "list", productCard: "editorial", categoryNav: "sticky", imageRatio: "portrait" }, capabilities: { dark: true, imageFirst: true, compact: false, immersive: true, featuredComposition: true, decorativeSurfaces: true, motion: true }, motion: "cinematic", preview: { className: "preview-noir", image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=1400&q=88" },
  },
  {
    ...
    tokens: { ...baseTokens, colors: { background: "#f6f0e5", foreground: "#344331", surface: "#fffdf8", surfaceMuted: "#ede3d1", border: "#e6dac7", primary: "#344331", primaryForeground: "#ffffff", accent: "#b78a42", accentForeground: "#ffffff", muted: "#756f63", mutedForeground: "#756f63" }, typography: { ...baseTokens.typography, headingWeight: 700, lineHeight: "1.6", letterSpacing: "-0.006em" }, shape: { ...baseTokens.shape, radiusSm: "0.375rem", radiusMd: "0.75rem", radiusLg: "1rem", radiusXl: "1.5rem" }, spacing: { page: "1rem", section: "3rem", card: "0.95rem", gap: "0.9rem" }, effects: { shadow: "0 8px 24px rgb(52 67 49 / .07)", shadowHover: "0 18px 40px rgb(52 67 49 / .13)", overlay: "rgb(18 26 16 / .48)" } },
    layout: { header: "hero", productGrid: "list", productCard: "editorial", categoryNav: "sticky", imageRatio: "landscape" }, capabilities: { dark: false, imageFirst: true, compact: false, immersive: false, featuredComposition: true, decorativeSurfaces: true, motion: true }, motion: "heritage", preview: { className: "preview-heritage", image: "https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?auto=format&fit=crop&w=1400&q=88" },
  },
  {
    ...
    layout: { header: "standard", productGrid: "gallery-grid", productCard: "vertical", categoryNav: "scroll", imageRatio: "portrait" }, capabilities: { dark: false, imageFirst: true, compact: false, immersive: false, featuredComposition: true, decorativeSurfaces: true, motion: true }, motion: "gallery", preview: { className: "preview-gallery", image: "https://images.unsplash.com/photo-1555507036-ab1f4038808a?auto=format&fit=crop&w=1400&q=88" },
  },
