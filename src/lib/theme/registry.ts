...
const definitions: readonly ThemeDefinition[] = [
  {
    ...
    description: { ar: "تصميم نظيف وسريع يضع القائمة والمعلومات في المقدمة.", en: "Clean, fast and focused on the menu itself." },
    promise: { ar: "الأساس الاحترافي لكل مطعم.", en: "The professional baseline for every restaurant." },
    tags: [{ ar: "مجاني", en: "Free" }, { ar: "سريع", en: "Fast" }, { ar: "واضح", en: "Clear" }],
    tokens: baseTokens,
