...
export type ThemeTokens = {
  ...
  readonly typography: { readonly displayFont: string; readonly bodyFont: string; readonly headingWeight: number; readonly bodyWeight: number; readonly lineHeight: string; readonly letterSpacing: string };
