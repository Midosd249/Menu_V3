...
export const AI_PROVIDER_REGISTRY: Readonly<Record<AiProviderFamily, AiProviderDescriptor>> = {
  ...
  mistral: { id:"mistral", lifecycle:"active", transport:"mistral_document_ai", role:"document_specialist", candidateCapabilities:["ocr_document","image","pdf","structured"], runtimeEligible:true, modelSelection:"configured", keyPoolSize:1, notes:"Mistral Document AI OCR specialist with document annotations for structured menu extraction; generic text routing remains isolated." },
