...
export const AI_PROVIDER_REGISTRY: Readonly<Record<AiProviderFamily, AiProviderDescriptor>> = {
  ...
  nvidia: { id:"nvidia", lifecycle:"planned", transport:"openai_compatible", role:"execution", candidateCapabilities:["structured","image"], runtimeEligible:false, modelSelection:"dynamic_catalog", keyPoolSize:2, notes:"Hosted NIM/API Catalog capability is model-dependent." },
  groq: { id:"groq", lifecycle:"planned", transport:"openai_compatible", role:"execution", candidateCapabilities:["structured","image"], runtimeEligible:false, modelSelection:"dynamic_catalog", keyPoolSize:1, notes:"OpenAI-compatible execution candidate; exact model contract must be verified before routing." },
  cloudflare: { id:"cloudflare", lifecycle:"planned", transport:"openai_compatible", role:"execution", candidateCapabilities:["structured"], runtimeEligible:false, modelSelection:"dynamic_catalog", keyPoolSize:1, notes:"Workers AI OpenAI-compatible chat/embedding boundary; Account ID and API token are required." },
