...
export const AI_PROVIDER_REGISTRY: Readonly<Record<AiProviderFamily, AiProviderDescriptor>> = {
  ...
  typesafe: { id:"typesafe", lifecycle:"active", transport:"typesafe_system_one", role:"decision_orchestrator", candidateCapabilities:["typed_decision"], runtimeEligible:true, modelSelection:"typed_decision", keyPoolSize:3, notes:"Jev/System One is the optional high-level decision layer; execution still falls back to validated providers when Jev is unavailable or low-confidence." },
  ...
  deepgram: { id:"deepgram", lifecycle:"active", transport:"deepgram_stt", role:"audio_specialist", candidateCapabilities:["audio_stt"], runtimeEligible:true, modelSelection:"configured", keyPoolSize:1, notes:"Deepgram pre-recorded STT specialist via POST /v1/listen; isolated from generic LLM routing and streaming transport." },
};
