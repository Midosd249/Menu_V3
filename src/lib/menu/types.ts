...
export type Tenant = { id: string; ownerUserId: string; slug: string; nameAr: string; nameEn: string; taglineAr: string; taglineEn: string; logoUrl: string; coverUrl: string; instagramUrl: string; websiteUrl?: string; snapchatUrl?: string; facebookUrl?: string; tiktokUrl?: string; whatsapp: string; whatsappTemplate: string; primaryColor: string; accentColor: string; themeKey: ThemeKey; currency: string; city: string; country: string; isPublished: boolean; isActive: boolean; createdAt: string; updatedAt: string };
