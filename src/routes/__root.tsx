...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: appCss }, { rel: "stylesheet", href: colorsCss }, { rel: "stylesheet", href: typographyCss },
      { rel: "stylesheet", href: imageArtDirectionCss }, { rel: "stylesheet", href: motionCss }, { rel: "stylesheet", href: accessibilityCss },
      { rel: "stylesheet", href: themeCss }, { rel: "stylesheet", href: essentialThemeCss }, { rel: "stylesheet", href: noirThemeCss },
      { rel: "stylesheet", href: themeRefinementsCss }, { rel: "stylesheet", href: themeRefinementsV2Css }, { rel: "stylesheet", href: noirHardeningCss },
      { rel: "stylesheet", href: editorialThemeCss }, { rel: "stylesheet", href: editorialHardeningCss }, { rel: "stylesheet", href: heritageThemeCss },
      { rel: "stylesheet", href: galleryThemeCss }, { rel: "stylesheet", href: galleryHardeningCss }, { rel: "stylesheet", href: publicThemeQualityRecoveryCss },
      { rel: "stylesheet", href: menuPreviewLayerCss }, { rel: "stylesheet", href: quickAddCompactRefinementCss }, { rel: "stylesheet", href: priceConsistencyCss },
...
function RootDocument() {
  ...
  return <html lang={locale} dir={locale === "ar" ? "rtl" : "ltr"} suppressHydrationWarning><head><HeadContent /></head><body><PreviewHostBridge /><AuthProvider><LangProvider initialLang={locale}><Outlet /></LangProvider></AuthProvider><Scripts /></body></html>;
}
