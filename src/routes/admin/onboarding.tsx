...
const labels = {
  ar: { pending: "بانتظار الاعتماد", approved: "معتمد", rejected: "مرفوض", all: "كل العملاء", title: "طلبات العملاء الجدد", subtitle: "مركز واحد لطلبات المطاعم الجديدة، سواء جاءت من نموذج الموقع أو من حساب تم إنشاؤه بالفعل. راجع، تواصل، اعتمد، ثم سلّم رابط التسجيل وQR عند الحاجة.", refresh: "تحديث", search: "ابحث باسم المطعم، المدينة، الجوال أو البريد", empty: "لا توجد طلبات عملاء مطابقة.", details: "تفاصيل العميل", business: "المطعم", city: "المدينة", phone: "الجوال", email: "البريد", submitted: "تاريخ الطلب", status: "الحالة", notes: "ملاحظات الإدارة", notesPlaceholder: "أضف ملاحظة داخلية…", approve: "اعتماد وإنشاء رابط", reject: "رفض الطلب", approvedMessage: "تم اعتماد العميل", rejectedMessage: "تم رفض الطلب", menu: "فتح المنيو", qr: "QR", copy: "نسخ الرابط", copied: "تم النسخ", call: "اتصال", whatsapp: "WhatsApp", emailAction: "بريد", overview: "إجمالي", pendingCount: "بانتظار الاعتماد", approvedCount: "معتمد", rejectedCount: "مرفوض", active: "الحساب نشط", published: "المنيو منشور", draft: "المنيو غير منشور", registration: "رابط التسجيل", copyRegistration: "نسخ رابط التسجيل", lead: "طلب من الموقع", account: "حساب مطعم" },
  en: { pending: "Pending approval", approved: "Approved", rejected: "Rejected", all: "All customers", title: "New Customer Requests", subtitle: "One workspace for new restaurant requests, whether they came from the website form or an already-created account. Review, contact, approve, and hand off registration and QR when needed.", refresh: "Refresh", search: "Search restaurant, city, phone, or email", empty: "No matching customer requests.", details: "Customer details", business: "Restaurant", city: "City", phone: "Phone", email: "Email", submitted: "Submitted", status: "Status", notes: "Admin notes", notesPlaceholder: "Add an internal note…", approve: "Approve & create link", reject: "Reject request", approvedMessage: "Customer approved", rejectedMessage: "Request rejected", menu: "Open menu", qr: "QR", copy: "Copy link", copied: "Copied", call: "Call", whatsapp: "WhatsApp", emailAction: "Email", overview: "Total", pendingCount: "Pending", approvedCount: "Approved", rejectedCount: "Rejected", active: "Account active", published: "Menu published", draft: "Menu not published", registration: "Registration link", copyRegistration: "Copy registration link", lead: "Website request", account: "Restaurant account" },
} as const;
