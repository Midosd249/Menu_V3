...
import { BarChart3, Building2, QrCode, Settings, LayoutDashboard, Palette, Upload, UtensilsCrossed, SlidersHorizontal, ExternalLink, Ellipsis, Users, ShieldCheck, Sparkles } from "lucide-react";
